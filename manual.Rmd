...
[**Markdown**](http://daringfireball.net/projects/markdown/basics) é uma linguagem de marcação simples inventada por John Gruber. Hoje, existem muitos programas para traduzir documentos escritos em Markdown para documentos em formato HTML, PDF ou mesmo Word (entre outros). R Markdown, por sua vez, é uma extensão do Markdown para incorporar código em execução, em R, e incluindo a saída do documento. Este documento mostra, por sua vez, três aspectos do R Markdown: como incluir formatação básica; como incluir o código R e a saída; e como incluir código matemático.
